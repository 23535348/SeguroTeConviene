                    ...
                    <div class="col-lg-12 ocultar_mov">
                        <div class="col-lg-3" align="center">
                            <ul class="nav nav-tabs tabs-left" style="padding-top:50px; padding-left:10px; padding-right:0px; width:180px; height:400px; z-index:50000000000000; margin-bottom:50px; background-color:#428bca; -webkit-border-top-right-radius: 10px; -webkit-border-bottom-right-radius: 10px; -moz-border-radius-topright: 10px; -moz-border-radius-bottomright: 10px; border-top-right-radius: 10px; border-bottom-right-radius: 10px;">
                                <li class="active">
                                    <a class="cambioColor"  data-toggle="tab" href="#QuienesSomos">Quiénes Somos</a>
                        ...
                        <div class="col-lg-9">
                            <div class="tab-content">
                                <div id="QuienesSomos" class="tab-pane active">
                                    <div class="col-lg-8">
                                        <div>
                                            <p align="justify">
                                                <b>SEGUROTECONVIENE.COM</b>
                                                es el primer portal en Internet de Panamá en donde podrá encontrar y comparar en un solo lugar las mejores ofertas para sus seguros de Automóvil, Incendio y Vida, brindándole en solo minutos opciones de las más reconocidas compañías de seguros del país, sin costos adicionales para usted, y una atención personalizada a través de nuestro experimentado equipo de trabajo.
                                                <br>
                                                <br>
                                                Formamos parte de la empresa de corretaje de seguros
                                                <b>JIMFOR, S.A.</b>
                                                , que con más de 35 años de experiencia en el mercado asegurador se ha posesionado como una de las empresas que mantiene el mejor reconocimiento por servicio al cliente.
                                                <br>
                                                <br>
                                                Somos una alternativa diferente, orientada a brindarle al público en general excelentes opciones en seguros a través de nuestra página web. Nuestra misión es buscarle la mejor alternativa a sus necesidades, ofreciéndole los mejores planes a precios reducidos.
                                                <br>
                                                <br>
                    ...
                    <div class="tabs-container tabla_oculta ">
                        <div class="tabs-left">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="active">
                                    <a href="#tab-5" data-toggle="tab" aria-expanded="true">Quiénes Somos</a>
                                </li>
                                <li class="">
