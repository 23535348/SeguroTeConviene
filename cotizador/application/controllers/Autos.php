...
//--------------------------- CALCULOS DE COMPRENSIVO ------------------------------
                ...
                $datos['precio_ventaForm'] = $this->min_numero($datos['precio_venta']);

    }
        }
        $this->load->view('autos/template', $datos);
...
$nombre_completo="$apellido $nombre";
       ...
       /* if(substr($_POST['aseguradora'],-1)==0)
        {
            $company="ASSA";
        }
        else if(substr($_POST['aseguradora'],-1)==1)
        {
            $company="SURA";
        }
        else if(substr($_POST['aseguradora'],-1)==2)
        {
            $company="Internacional de Seguros";
        }
        else if(substr($_POST['aseguradora'],-1)==3)
        {
            $company="Banesco";
        }
        else if(substr($_POST['aseguradora'],-1)==4)
        {
            $company="HSBC";
        }
        else if(substr($_POST['aseguradora'],-1)==5)
        {
            $company="GENERALI";
        }
*/
       ...
       // $datos['solicitud']=1;
        ...
        switch ($plan) {
            ...
            case "Ejecutivo":
                ...
                break;
            case "Premium":
                $datos['mensaje_lc'] = "$50,000 por persona, $100,000 por accidente";
                $datos['mensaje_dpa'] = "$50,000 por accidente";
                $datos['mensaje_gm'] = "$10,000 por persona, $50,000 por accidente";
                break;
        }
        ...
        $this->load->view('autos/complete', $datos);
       // $this->load->view('autos/imprimir_terceros', $datos);
    ...
    public function imprimir_terceros(){
        ...
        $this->load->view('autos/imprimir_terceros_pdf',$datos);
    }


    public function redireccion(){

        $this->load->view('autos/complete');
        }
