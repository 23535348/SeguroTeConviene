...
<? if(isset($brandon)){
    if($brandon==1){?>
        ...
        <div class="row">
            <div class="aseguradoras col-lg-2" style="margin-left:34.5%;">
                <div class="encabez">
                    Seguro de Vida
                </div>
...
echo  $idaseguradora;*/
                switch ($nombre_aseguradora){
                    case "Internacional de Seguros":?>
                        <div class="logos col-lg-3" style="text-align:right;"><!--<?=$detalle_factor?>--><img src="<?= $url ?>img/logos/iseguros133.png"></div>
                        <?php
                        $logo_compania_seguros = "<img src='".$url."img/logos/iseguros133.png'>";
                        break;
                    case "Generali":?>
                        <div class="logos col-lg-3" style="text-align:right;"><img src="<?= $url ?>img/logos/generali.png"></div>
                        <?php
                        $logo_compania_seguros = "<img src='".$url."img/logos/generali.png'>";
                        break;
                    case "ASSA":?>
                        <div class="logos col-lg-3" style="text-align:right;"><img src="<?= $url ?>img/logos/assa.png"></div>
                        <?php
                        $logo_compania_seguros = "<img src='".$url."img/logos/assa.png'>";
                        break;
                    case "Banesco":?>
                        <div class="logos col-lg-3" style="text-align:right;"><img src="<?= $url ?>img/logos/banesco.png"></div>
                        <?php
                        $logo_compania_seguros = "<img src='".$url."img/logos/banesco.png'>";
                        break;
                    case "Acerta":?>
                        <div class="logos col-lg-3" style="text-align:right;"><img src="<?= $url ?>img/logos/acerta.png"></div>
                        <?php
                        $logo_compania_seguros = "<img src='".$url."img/logos/acerta.png'>";
                        break;
                    case "Banistmo":?>
                        <div class="logos col-lg-3" style="text-align:right;"><img src="<?= $url ?>img/logos/HSBC_Seguros.png"></div>
                        <?php
                        $logo_compania_seguros = "<img src='".$url."img/logos/HSBC_Seguros.png'>";
                        break;
                    case "SURA":?>
                        <div class="logos col-lg-3" style="text-align:right;"><img src="<?= $url ?>img/logos/sura.png"></div>
                        <?php
                        $logo_compania_seguros = "<img src='".$url."img/logos/sura.png'>";
                        break;
                } ?>
                <div class="aseguradoras0 col-lg-5">
  ...
  <div class="basico" style="margin: 0 auto 0 auto; width:193px;"><p>Prima Anual</p></div></div>



            <div class="col-lg-2 precio" style="margin-left:5%; width:90px;">B/. <?php echo number_format($prima_planeada, "2", ".", ","); ?></div>
                <?php if($prima_vida<1 || $prima_incendio<1 || $prima_planeada<1) {?>

                <a href="#"><button class="btn btn-warning btn-small" style="margin-top:0;" type="button" disabled>
                Solicitar
