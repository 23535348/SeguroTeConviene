           ...
           $prima_basico_total=12345;
            ...
            switch ($nombre_aseguradora){
                case "Internacional de Seguros":?>
                    <div class="logos col-xs-12" align="center"><img class="img-responsive" src="<?= $url ?>img/logos/iseguros133.png"></div>
                    <?php $idaseguradora=1; ?>
                    <?php break;
                case "Generali":?>
                    <div class="logos col-xs-12" align="center"><img class="img-responsive" src="<?= $url ?>img/logos/generali.png"></div>
                    <?php $idaseguradora=2; ?>
                    <?php break;
                case "ASSA":?>
                    <div class="logos col-xs-12" align="center"><img class="img-responsive" src="<?= $url ?>img/logos/assa.png"></div>
                    <?php $idaseguradora=3; ?>
                    <?php break;
                case "Banesco":?>
                    <div class="logos col-xs-12" align="center"><img class="img-responsive" src="<?= $url ?>img/logos/banesco.jpg"></div>
                    <?php $idaseguradora=4; ?>
                    <?php break;
                case "Acerta":?>
                    <div class="logos col-xs-12" align="center"><img class="img-responsive" src="<?= $url ?>img/logos/acerta.png"></div>
                    <?php $idaseguradora=5; ?>
                    <?php break;
                /*  case "Banistmo":?>
                      <div class="logos col-lg-2 col-offset-2"><img src="img/logos/HSBC_Seguros.png"></div>
                                                      <?php $idaseguradora=6; ?>
                      <?php break; */
                case "SURA":?>
                    <div class="logos col-xs-12" align="center"><img class="img-responsive" src="<?= $url ?>img/logos/sura.png"></div>
                    <?php $idaseguradora=7; ?>
                    <?php break;
            } ?>
            <div class="col-xs-12">
    ...
    <div class="modal-dialog">
      <div class="modal-content" style="position:absolute;">
        ...
        <div class="modal-body">
			<span class="col-lg-6" style="display:inline-block;">
            ...
            <div class="col-xs-12 aseguradoras" >
                ...
                <?php if($prima_ejecutivo_total<1){?>
                <!--
                <button class="btn btn-warning btn-small" style="margin-top:0;" type="button" disabled><p class="msj">No Cotizable</p></button>
                --><?php } else {?>
        ...
        <div class="modal-body">
            ...
            <div class="col-xs-12 aseguradoras" >
                ...
                <div class="col-xs-6 letras-resultado-prima" align="center"><u>B/.
                    ...
                    <?}else{?>
                        <a href="validator/?nombre=<?=$nombre?>&apellido=<?=$apellido?>&cedula=<?=$cedula?>&colision=<?=$calculo_colision_premium?>&dcolision=<?=$calculo_deducible_colision_premium?>&comprensivo=<?=$calculo_comprensivo_premium?>&dcomprensivo=<?=$calculo_deducible_comprensivo_premium?>&company=<?=$nombre_aseguradora?>&historial=<?=$historial_manejo?>&plan=Premium&poliza=<?=$prima_premium_total?>&marca=<?=$marca?>&modelo=<?=$modelo?>&idaseguradora=<?=$idaseguradora?>&anio_auto=<?=$anio_auto?>&sexo=<?=$sexo?>&tipo_auto=<?=$tipo_auto?>&estado_civil=<?=$estado_civil?>&fecha_nac=<?=$fecha_nac?>&precio_venta=<?=$precio_venta?>&email=<?=$email?>&estado_auto=<?=$estado_auto?>&telefono=<?=$telefono?>&celular=<?=$celular?>">
                            <?php echo number_format($prima_basico_total, "2", ".", ","); ?></a>
                    <?}?>
...
Div de cierre del tabs
            ...
            if(contador==maximo)
               ...
               // $(".tab-pane").removeClass("active");
                for (var x = 1; x <= maximo; x++) {
                    document.getElementById('tab_' + x).className = 'row tab-pane';
                }
                document.getElementById('tab_' + contador).className = 'active row tab-pane';
            }
        }
    ...
    <!-- <form name="controles">
   <div class="col-xs-12" align="center" id="resultados2">
       ...
       <div class="col-xs-2">
           <a class="cambioColor"  data-toggle="tab" href="#QuienesSomos" onClick="decrementar()" >
               <img class="img-responsive"  src="<?= $url ?>img/direction_bajo.png">
           </a>
       </div>
       <div class="col-xs-2">
           <a class="cambioColor"  data-toggle="tab" href="#QuienesSomos" onClick="incrementar()">
               <img class="img-responsive"  src="<?= $url ?>img/direction_up.png">
           </a>
       </div>
           <div class="col-xs-4">
           </div>
    ...
    <div class="col-xs-12" align="center"><? $basico="basico"; $premium="premium"; $ejecutivo="ejecutivo";?>
        <button type="button" class="btn btn-tema" onclick="OcultarDiv('<?=$basico?>','<?=$iteracion?>');">Regresar</button>
    </div>
</div>
...
<?}?>
    ...
    <div class="col-xs-12" align="center"><? $basico="basico"; $premium="premium"; $ejecutivo="ejecutivo";?>
        <button type="button" class="btn btn-tema" onclick="OcultarDiv('<?=$ejecutivo?>','<?=$iteracion?>');">Regresar</button>
    </div>
</div><?}?>
    ...
    <div  class="letras_resultado_informacion" style="display:none" id="aseguradora_plan_premiun<?=$iteracion?>">
        ...
        <div class="col-xs-12" align="center"><? $basico="basico"; $premium="premium"; $ejecutivo="ejecutivo";?>
            <button type="button" class="btn btn-tema" onclick="OcultarDiv('<?=$premium?>','<?=$iteracion?>');">Regresar</button>
        </div>
    </div>
<? }?>
...
$iteracion++;
    ...
    <form method="POST" action="<?=$url?>cotizador/index.php/Autos/form">
            ...
            <div class="tab-content">
                    ...
                    <div >
                        ...
                        <div class="col-xs-12" style="margin-bottom:16px;">
                            <input class="form-control" type="text" onchange="act_apellido()" placeholder="Apellído"  last name="apellido" required="" tabindex="2">
...
<i class="icon-th"></i>
    ...
    <div class="col-xs-12">
        <div  class="col-xs-12" >
            <div  class="col-xs-12"  style="margin-bottom:16px;">
                <select id="item1_select_1" required tabindex="1" class="form-control" name="item1_select_1">
                    <option value="">Marca</option>
                    <?php
                    foreach ($marcas as $i => $marcas_result)
                        if( $marcas==$i){
                            echo '<option value="'.$i.'"  selected>'.$marcas_result.'</option>';
                        }else {
                            echo '<option value="'.$i.'">' . $marcas_result . '</option>';
                        }
                    ?>
                </select>
            </div>
            <div class="col-xs-12" style="margin-bottom:16px;">
                <div id="modelosdiv">
                    <select tabindex="3" required class="form-control" name="ittem2_select_2" id="item2_select_2">
        ...
        <div class="col-xs-12" >
            <div class="col-xs-12" style="margin-bottom:16px;">
                <!-- <input tabindex="2" type="text" name="precio_venta" class="form-control" placeholder="Valor del Veh&iacute;culo"> -->
                <input required tabindex="2" type="text" onblur="validatePrice()" name="precio_venta" id="precio_venta" class="form-control" placeholder="Valor Real Actual del Veh&iacute;culo" style="display:inline; width:100%;">

               <!-- <span id="tooltip" data-toggle="tooltip" data-placement="right" data-original-title="Valor real actual del vehículo:  Valor de compra menos 15% de depreciaci&oacute;n por cada a&ntilde;o de uso." class="glyphicon glyphicon-info-sign black"></span>-->
            ...
            <div class="col-xs-12" style="margin-bottom:16px;">
                <select tabindex="4" required name="tipo_auto" class="form-control">
                    <option>Tipo de Veh&iacute;culo</option>
                    <option value="Sedan">Sedan</option>
                    <option value="SUV">4X4, 4X2 o Camioneta</option>
            ...
            <div class="col-xs-12" style="margin-bottom:16px;">
                <select tabindex="6" required name="estado_auto" class="form-control">
                    <option>Estado del Veh&iacute;culo</option>
            ...
            <div id="myTab" class="row">
                <div>
                        ...
                        <div class="col-xs-12"><a href="#personal"></a>
                            <button type="button" class="btn btn-tema" onclick="echandoPatras();return false;">ATRAS</button>&nbsp;<button type="submit" class="btn btn-siguiente">CONTINUAR</button></div>
                    </div>
 ...
 <script type="text/javascript" src="http://postlink.googlecode.com/svn/trunk/jquery.postlink.js"></script>
    ...
    <script>
        ...
        $('#scroll-nav > nav > button').click(function(){
            ...
            $('#scroll-stage').scrollTo($chScrollPositions[next]);
        });
        // [end] Demo Code //
    </script>
