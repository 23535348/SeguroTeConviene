...
border-bottom-left-radius: 5px;">
            ...
            <div id=2 class="col-lg-4">
                <div style="color:#fff; background-color:#adadad;width:100%;padding:8px;display:inline-block;-webkit-border-top-right-radius: 5px; -webkit-border-bottom-right-radius: 5px; -moz-border-radius-topright: 5px; -moz-border-radius-bottomright: 5px; border-top-right-radius: 5px; border-bottom-right-radius: 5px;">
                    <img src="<?= $url ?>img/2.png">
                    <b>CONTRATAR SU SEGURO</b>
                </div>
            </div>
...
switch ($nombre_aseguradora){
                            case "Internacional de Seguros":?>
                                ...
                                <div class="logos col-lg-12 col-offset-2"><img src="<?=$url?>img/logos/iseguros133.png"></div>

                                <?php break;
                            case "Generali":?>

                                <div class="logos col-lg-12 col-offset-2"><img src="<?=$url?>img/logos/generali.png"></div>

                                <?php break;

                            case "ASSA":?>

                                <div class="logos col-lg-12 col-offset-2"><img src="<?=$url?>img/logos/assa.png"></div>

                                <?php break;
                            case "Banesco":?>

                                <div class="logos col-lg-12 col-offset-2"><img src="<?=$url?>img/logos/banesco.jpg"></div>

                                <?php break;
                            case "Acerta":?>

                                <div class="logos col-lg-12 col-offset-2"><img src="<?=$url?>img/logos/acerta.png"></div>

                                    <?php break;
                            case "Banistmo":?>

                                <div class="logos col-lg-12 col-offset-2"><img src="<?=$url?>img/logos/HSBC_Seguros.png"></div>

                                    <?php break;
                            case "SURA":?>

                                <div class="logos col-lg-12 col-offset-2"><img src="<?=$url?>img/logos/sura.png"></div>
            ...
            <div class="col-lg-4" >
                      ...
                      <div class="col-lg-12 basico" align="Center">

                       <div class=""><p>Prima Anual</p></div>

</div>



                                        <div class="col-lg-5 precio">B/.<?php echo number_format($prima_basico_conimpuesto, "2", ".", ","); ?>
                                        </div>
                                                   <div class="col-lg-6" align="Center">
                       <div class="col-lg-12">
                      <?php if($prima_basico_conimpuesto < 1){?>
                        <p class="msj">No Cotizable</p> <a href="#?<?php $empresa=$empresa+1;?>">
                                        <button class="btn btn-warning btn-small" style="margin-top:0;" type="button" disabled>Solicitar <i class="glyphicon glyphicon-circle-arrow-right"></i></button></a>
...
<?}?>
		...
		<?php } else {?>
				                 ...
				                 <div class="row">
				                 <div class="col-lg-12">
                                    <a style="color:#1E90FF; text-decoration:none;" data-toggle="modal" href="#myModal<?php $y=$y+1; echo $y;?>">
                                    Mas información</a>
                                     </div>
                                                                 </div>
                                                                  </div><!-- Modal -->
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
			<span style="display:inline-block;">
			  Compañia de Seguros: <?php if($nombre_aseguradora=="Internacional de Seguros") {?><br><br><img src="<?=$url?>img/logos/iseguros.png"><br><br><?php }?>
...
<?php } ?>
         ...
         <div class="col-lg-4" >
                      ...
                      <div class="col-lg-12 basico" align="Center">
                                    ...
                                    <div class="col-lg-5 precio">B/.<?php echo number_format($prima_completo_conimpuesto, "2", ".", ","); ?></div>
  ...
  <form name="AseguradoraBasico<?=$iteracion?>" id="Aseguradora<?=$iteracion?>" action="validator" method="POST">
   ...
   <input type="hidden" name="celular" value="<?=$celular?>">
	...
	&suma=<?php echo $prima_completo_conimpuesto; ?>"><button class="btn btn-warning btn-small" type="button">Solicitar <i class="glyphicon glyphicon-circle-arrow-right"></i></button></a>-->
                      ...
                      <div class="col-lg-12 ">
                           <a style="color:#1E90FF; text-decoration:none;" data-toggle="modal" href="#MyModal<?php $y=$y+1; echo $y;?>">Mas información</a>
    ...
    <div class="modal-dialog col-lg-10">
      <div class="modal-content">
        ...
        <div class="modal-body">
			<span style="display:inline-block;">
			  Compañia de Seguros: <?php if($nombre_aseguradora=="Internacional de Seguros") {?><br><br><img src="<?=$url?>img/logos/iseguros.png"><br><?php }?>
                            ...
                            <div class="col-lg-4">
                                ...
                                <div >
                                    ...
                                    <div class="col-lg-12" style="margin-bottom:16px;">
                                            ...
                                            <input id="suma_asegurada" class="form-control" type="text" placeholder="Valor a Asegurar en Dólares" name="suma_asegurada" onblur="validatePrice()" size="10" required="">
