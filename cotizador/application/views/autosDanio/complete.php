...
<!-- 3ra tabla -->
    ...
    <div class="col-xs-12 " style="text-align:center;">
        <div class="row">
            <div class="col-xs-6 ">
                <form  action="<?=$url?>cotizador/index.php/AutosDanio/Cotizador_d" method="POST">
                    ...
                    <button type=submit class="btn" style="background-color:#428bca;border-color: #428bca; color: #fff;margin-top:10px; color: #fff;">Regresar</button>
          ...
          <!--  <a href="javascript:window.history.go(-1);"><button class="btn" style="background-color:#428bca;border-color: #428bca; color: #fff;margin-top:10px; color: #fff;">Regresar</button></a>
            ...
            <div class="col-xs-6 ">
            <form  action="<?=$url?>cotizador/index.php/AutosDanio/autos_complete" method="POST">
            <input type="hidden" name="nombre" value="<?=$nombre?>">
            <input type="hidden" name="apellido" value="<?=$apellido?>">
            <input type="hidden" name="cedula" value="<?=$cedula?>">
            <!--   <input type="hidden" name="colision" value="<?=$calculo_colision_premium?>">
