...
$pdf->SetTextColor(0,0,0);
$pdf->Cell(189,5,utf8_decode('Esta cotización está sujeta a la inspección del automóvil y'),0,1,'L');
$pdf->Cell(189,5,utf8_decode('verificación de historial de tránsito del contratante o asegurado.'),0,1,'L');
$pdf->Ln(2);
