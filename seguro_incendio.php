        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="gris">
                        Seguro para Incendio de Estructura Residencial
                    </div>
                    ...
                    <div class="col-lg-12 ocultar_mov">
                        <div class="col-lg-3" align="center">
                            <ul class="nav nav-tabs tabs-left" style="padding-top:50px; padding-left:10px; padding-right:0px; width:180px; height:400px; z-index:50000000000000; margin-bottom:50px; background-color:#428bca; -webkit-border-top-right-radius: 10px; -webkit-border-bottom-right-radius: 10px; -moz-border-radius-topright: 10px; -moz-border-radius-bottomright: 10px; border-top-right-radius: 10px; border-bottom-right-radius: 10px;">
                                <li class="active">
                                    <a class="cambioColor"  data-toggle="tab" href="#SeguroIncendio">Seguro de Incendio</a>
                        ...
                        <div class="col-lg-9">
                            <div class="tab-content">
                                <div id="SeguroIncendio" class="tab-pane active">
                                    <div class="col-lg-8">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="cotizador_a.php">
                                                <img align="left" style="margin-right:8px;" src="img/incendio.png">
                                            </a>

                                        </div>
                                        <div class="col-lg-8" align="justify">
                                            Sabemos que tan importante es su residencia para usted, y queremos brindarle el mejor seguro de incendio para cubrir daños a su propiedad, y que en caso de un siniestro su patrimonio financiero no se vea debilitado.
                                            <br>

                                            A través de nuestro sitio web le ofrecemos dos opciones para el seguro de incendio de su Residencia (estructura/no contenido), la primera con las coberturas básicas exigidas por la mayoría de los bancos en sus transacciones hipotecarias, la cual  incluye las coberturas de Incendio, Terremoto, Vendaval, Inundación y Daños
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12" align="justify">
                                            Por Agua, y la segunda opción con coberturas adicionales como Desórdenes Públicos y Daños por Maldad.
                                            <br>
                                            Es importante que a la hora de cotizar un seguro de Incendio tenga los valores actualizados de su vivienda, o el costo de reconstrucción de la misma, el cual es el que debe utilizar para asegurarla.
                                            <br>

                                            Mucha veces utilizamos valores que no son los adecuados y a la hora de un siniestro cubierto por la póliza nos vemos afectados por cláusulas que se aplican a estos valores y que nos hacen partícipes porcentualmente de la pérdida, ocasionando disgustos e insatisfacciones. Si no está claro en el valor de su residencia consulte a un especialista en la materia.
                                        </div>
                                    </div>
                                ...
                                <div id="sev" class="tab-pane link1">
                                    ...
                                    <div class="col-lg-4">
                                        <div>
                                            <div id="side-b" class="activarPanel2" align="center">
                                                <a href="#siniestro">
                    ...
                    <div class="tabs-container tabla_oculta ">
                        <div class="tabs-left">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="active">
                                    <a href="#tab-5" data-toggle="tab" aria-expanded="true">Seguro de Incendio</a>
                                </li>
                                <li class="">
