                    ...
                    <div class="col-lg-12 ocultar_mov">
                        <div class="col-lg-3" align="center">
                            <ul class="nav nav-tabs  tabs-left" style="padding-top:50px; padding-left:10px; padding-right:0px; width:180px; height:400px; z-index:50000000000000; margin-bottom:50px; background-color:#428bca; -webkit-border-top-right-radius: 10px; -webkit-border-bottom-right-radius: 10px; -moz-border-radius-topright: 10px; -moz-border-radius-bottomright: 10px; border-top-right-radius: 10px; border-bottom-right-radius: 10px;">
                                <li class="active">
                                    <a class="cambioColor"  data-toggle="tab" href="#Vida">Seguro de Vida</a>
                        ...
                        <div class="col-lg-9">
                            <div class="tab-content tablaTabs">
                                <div id="Vida" class="tab-pane active">
                                    <div class="col-lg-8">
                                        <div class="row">
                                            <div class="col-lg-4">

                                                <a href="cotizador_a.php">
                                                    <img align="left" style="margin-right:8px;" src="img/vida.png">
                                                </a>

                                            </div>
                                            <div class="col-lg-8" align="justify">
                                                En
                                                <b>SEGUROTECONVIENE.COM</b>
                                                entendemos las necesidades primordiales que tiene cada persona al momento de contratar un seguro de vida. La mayoría lo contrata para darle protección financiera a su familia, otros para respaldar préstamos hipotecarios o personales, y algunos como una forma de planeación financiera para el futuro, sin embargo existe un factor común en todos ellos y es el de llenar ese vacío financiero que se ocasionaría al ocurrir la muerte prematura del padre o madre de familia.
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12" align="justify">
                                                Muchas personas tienen la mala idea que los seguros de vida son un producto de alto costo, y esto no es correcto, es posible contratar un seguro de vida para usted por pocos dólares al mes dependiendo de su edad, género y salud.
                                                <br>

                                                Le podemos ofrecer seguros de vida a término para cumplir con todas sus necesidades financieras, contratados a través de compañías de seguros de reconocida reputación nacional, y con altos índices de liquidez en sus operaciones, lo que le brinda tranquilidad y seguridad para toda su familia.
                                                <br>

                                                El seguro de Vida es la mejor herencia que le puede dejar a sus seres queridos, es un legado de amor y buena voluntad hacia ellos que siempre se lo agradecerán.
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div>
                                            <div id="side-b"  align="center">
                                                <a href="#sev" class="activarPanel" data-toggle="">
                                                    <img class="img-thumbnail banners" src="img/1.jpg">
                                                </a>
                                                <br>
                                                <br>
                                                <a href="cotizador_c.php">
                                ...
                                <div id="sev" class="tab-pane link1">
                                    <div class="col-lg-8">
                                        <div>
                                    ...
                                    <div class="col-lg-4">
                                        <div>
                                            <div id="side-b" class="activarPane2" align="center">
                                                <a href="#siniestro">
                                ...
                                <div id="siniestro" class="tab-pane link2">
                                    <div class="col-lg-8">
                                        <p>
                    ...
                    <div class="tabs-container tabla_oculta ">
                        <div class="tabs-left">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="active">
                                    <a href="#tab-5" data-toggle="tab" aria-expanded="true">Seguro de Vida</a>
                                </li>
                                <li class="">
