                    ...
                    <div class="col-lg-12 ocultar_mov">
                        <div class="col-lg-3" align="center">
                            <ul class="nav nav-tabs tabs-left" style="padding-top:50px; padding-left:10px; padding-right:0px; width:180px; height:400px; z-index:50000000000000; margin-bottom:50px; background-color:#428bca; -webkit-border-top-right-radius: 10px; -webkit-border-bottom-right-radius: 10px; -moz-border-radius-topright: 10px; -moz-border-radius-bottomright: 10px; border-top-right-radius: 10px; border-bottom-right-radius: 10px;">
                                <li class="active">
                                    <a class="cambioColor"  data-toggle="tab" href="#SeguroDeAuto">Seguro de Auto</a>
                        ...
                        <div class="col-lg-9">
                            <div class="tab-content">
                                <div id="SeguroDeAuto" class="tab-pane active">
                                    <div class="col-lg-8">
                                        <div>
                                            <div class="col-lg-6">

                                                <div align="center">
                                                    <p style="font-size:17px; text-align:center; color:#357ebd;">
                                                        <b>DAÑOS A TERCEROS</b>
                                                    </p>
                                                    <a href="autos_terceros.php">
                                                        <img src="img/terceros.png">
                                                    </a>
                                                    <br>
                                                    <br>
                                                    <p style="text-align:justify;">La póliza con cobertura de Daños a Terceros ampara al Asegurado unicamente por los daños ocasionados por su vehículo a bienes de terceros y personas a través de su cobertura de Lesiones Corporales y Daños a la Propiedad Ajena.</p>
                                            ...
                                            <div class="col-lg-6">
                                                <div align="center">
                                                    ...
                                                    <a href="cotizador.php">
                                                        <img src="img/vehiculos.png">
                                                    </a>
                                                    <br>
                                                    <br>
                                                    <p style="text-align:justify;">El seguro de auto con Cobertura Completa ampara al Asegurado por los daños ocasionados por su vehículo a terceros en sus bienes y personas, al igual que los daños propios al automóvil, asegurado por colisión, incendio y robo parcial o total del mismo.</p>
                                                </div>
                                            </div>
                    ...
                    <div class="tabs-container tabla_oculta ">
                        <div class="tabs-left">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="active">
                                    <a href="#tab-5" data-toggle="tab" aria-expanded="true">Seguro de Auto</a>
                                </li>
                                <li class="">
